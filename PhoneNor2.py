...
It uses an internal country code list and a backup `Country_codes.xlsx` file.
""")
...
# ---------------------------
# Load External Fallback File (Developer’s Country_codes.xlsx)
# ---------------------------
@st.cache_data
...
uploaded_data = st.file_uploader("Upload CSV or Excel file with 'Zip/PostalCode', 'Phone Number', and 'Country'", type=["csv", "xlsx"])
